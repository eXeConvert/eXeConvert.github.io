...
const dictionaries: Record<Locale, Record<string, string>> = {
  es: {
    ...
    'app.lede': 'Convierte archivos <code>.elp</code> y <code>.elpx</code> a <code>.docx</code>, <code>.pdf</code> o <code>.md</code>, y también importa <code>.docx</code>, <code>.md</code>, <code>.html</code> o <code>.tex</code> a <code>.elpx</code>.',
    ...
    'drop.help': 'Archivos compatibles: <code>.elp</code>, <code>.elpx</code>, <code>.docx</code>, <code>.md</code>, <code>.html</code>, <code>.tex</code> y <code>.zip</code> (página web o documento LaTeX con sus imágenes).',
    ...
    'status.unsupported': 'Formato no compatible. Usa un archivo .elp, .elpx, .docx, .md, .html, .tex o .zip.',
    'status.unrecognizedZip': 'El .zip no contiene un proyecto de eXeLearning, una página .html ni un documento .tex.',
    'status.latexDetected': 'Documento LaTeX detectado. Revisa la estructura de páginas y pulsa convertir.',
    'status.latexUnrecognized': 'Comandos de LaTeX sin conversión (se ha conservado su texto): {list}.',
    'status.htmlDetected': 'Página HTML detectada. Revisa la estructura de páginas y pulsa convertir.',
    ...
    'detected.htmlToElpx': 'Se importará la página HTML para generar un proyecto <code>.elpx</code>.',
    'detected.htmlToElpxDone': 'Se importó la página HTML para generar un proyecto <code>.elpx</code>.',
    'detected.latexToElpx': 'Se importará el documento LaTeX para generar un proyecto <code>.elpx</code>. Las fórmulas se conservan en LaTeX. Para incluir imágenes y archivos de <code>\\input</code>, sube un <code>.zip</code> con todo el proyecto.',
    'detected.latexToElpxDone': 'Se importó el documento LaTeX para generar un proyecto <code>.elpx</code>.',
    ...
    'source.htmlImport': 'Importación HTML',
    'source.latexImport': 'Importación LaTeX',
    ...
    'progress.readHtml': 'Leyendo el archivo HTML...',
    'progress.parseHtmlStructure': 'Interpretando la estructura del HTML...',
    'progress.readLatex': 'Leyendo el documento LaTeX...',
    'progress.parseLatexStructure': 'Interpretando la estructura del documento LaTeX...'
  },
  ca: {
    'lang.label': 'Idioma',
    'lang.es': 'Español',
    ...
    'app.lede': 'Converteix fitxers <code>.elp</code> i <code>.elpx</code> a <code>.docx</code>, <code>.pdf</code> o <code>.md</code>, i també importa <code>.docx</code>, <code>.md</code>, <code>.html</code> o <code>.tex</code> a <code>.elpx</code>.',
    ...
    'drop.help': 'Fitxers compatibles: <code>.elp</code>, <code>.elpx</code>, <code>.docx</code>, <code>.md</code>, <code>.html</code>, <code>.tex</code> i <code>.zip</code> (pàgina web o document LaTeX amb les seves imatges).',
    ...
    'status.unsupported': 'Format no compatible. Fes servir un fitxer .elp, .elpx, .docx, .md, .html, .tex o .zip.',
    'status.unrecognizedZip': 'El .zip no conté cap projecte d’eXeLearning, cap pàgina .html ni cap document .tex.',
    'status.latexDetected': 'Document LaTeX detectat. Revisa l’estructura de pàgines i prem convertir.',
    'status.latexUnrecognized': 'Ordres de LaTeX sense conversió (se n’ha conservat el text): {list}.',
    'status.htmlDetected': 'Pàgina HTML detectada. Revisa l’estructura de pàgines i prem convertir.',
    ...
    'detected.htmlToElpx': 'S’importarà la pàgina HTML per generar un projecte <code>.elpx</code>.',
    'detected.htmlToElpxDone': 'S’ha importat la pàgina HTML per generar un projecte <code>.elpx</code>.',
    'detected.latexToElpx': 'S’importarà el document LaTeX per generar un projecte <code>.elpx</code>. Les fórmules es conserven en LaTeX. Per incloure imatges i fitxers d’<code>\\input</code>, puja un <code>.zip</code> amb tot el projecte.',
    'detected.latexToElpxDone': 'S’ha importat el document LaTeX per generar un projecte <code>.elpx</code>.',
    ...
    'source.htmlImport': 'Importació HTML',
    'source.latexImport': 'Importació LaTeX',
    'format.markdown': 'Markdown',
    'format.pdf': 'PDF',
    'format.docx': 'DOCX',
    ...
    'progress.readHtml': 'Llegint el fitxer HTML...',
    'progress.parseHtmlStructure': 'Interpretant l’estructura de l’HTML...',
    'progress.readLatex': 'Llegint el document LaTeX...',
    'progress.parseLatexStructure': 'Interpretant l’estructura del document LaTeX...'
  },
  en: {
    'lang.label': 'Language',
    'lang.es': 'Español',
    ...
    'app.lede': 'Convert <code>.elp</code> and <code>.elpx</code> files to <code>.docx</code>, <code>.pdf</code>, or <code>.md</code>, and also import <code>.docx</code>, <code>.md</code>, <code>.html</code>, or <code>.tex</code> into <code>.elpx</code>.',
    ...
    'drop.help': 'Supported files: <code>.elp</code>, <code>.elpx</code>, <code>.docx</code>, <code>.md</code>, <code>.html</code>, <code>.tex</code>, and <code>.zip</code> (web page or LaTeX document with its images).',
    ...
    'status.unsupported': 'Unsupported format. Use a .elp, .elpx, .docx, .md, .html, .tex, or .zip file.',
    'status.unrecognizedZip': 'The .zip holds no eXeLearning project, .html page or .tex document.',
    'status.latexDetected': 'LaTeX document detected. Review page structure and click convert.',
    'status.latexUnrecognized': 'LaTeX commands with no conversion (their text was kept): {list}.',
    'status.htmlDetected': 'HTML page detected. Review page structure and click convert.',
    ...
    'detected.htmlToElpx': 'The HTML page will be imported to generate an <code>.elpx</code> project.',
    'detected.htmlToElpxDone': 'The HTML page was imported to generate an <code>.elpx</code> project.',
    'detected.latexToElpx': 'The LaTeX document will be imported to generate an <code>.elpx</code> project. Formulas stay in LaTeX. To include images and <code>\\input</code> files, upload a <code>.zip</code> with the whole project.',
    'detected.latexToElpxDone': 'The LaTeX document was imported to generate an <code>.elpx</code> project.',
    ...
    'source.htmlImport': 'HTML import',
    'source.latexImport': 'LaTeX import',
    'format.markdown': 'Markdown',
    'format.pdf': 'PDF',
    'format.docx': 'DOCX',
    ...
    'progress.readHtml': 'Reading HTML file...',
    'progress.parseHtmlStructure': 'Interpreting HTML structure...',
    'progress.readLatex': 'Reading LaTeX document...',
    'progress.parseLatexStructure': 'Interpreting LaTeX document structure...'
  },
};
